...
class MarkerRecordsWrapper(MarkerRecords, RecordsAPIMixin):
    ...
    def plot_barcode(self, cb, **kwargs):
        ...
        See Also
        --------
        coelsch.plot.single_cell_markerplot : The underlying plotting function with
...
class PredictionRecordsWrapper(PredictionRecords, RecordsAPIMixin):
    ...
    def plot_recombination_landscape(self, **kwargs):
        ...
        See Also
        --------
        coelsch.plot.plot_recombination_lanscape : The underlying plotting function with
            full customization options.
        """
    ...
    def plot_allele_ratio(self, **kwargs):
        ...
        See Also
        --------
        coelsch.plot.plot_allele_ratio : The underlying plotting function with
            full customization options.
        """
