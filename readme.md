...
* `coelsch loadbam`: read a bam file aligned with cell barcode and haplotype alignment tags. The best way to generate this is using the [`coelsch_mapping_pipeline`](https://github.com/schneebergerlab/coelsch_mapping_pipeline.git), and end-to-end haplotype and single-cell aware alignment pipeline using `STAR` consensus for haplotype aware alignment.
